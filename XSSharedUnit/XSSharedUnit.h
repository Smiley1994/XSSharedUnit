...
//  Copyright © 2020 Good_Morning_. All rights reserved.
//
...
//! Project version string for XSSharedUnit.
FOUNDATION_EXPORT const unsigned char XSSharedUnitVersionString[];
